...
export default function RestaurantScreen() {
  ...
  useEffect(() => {
    dispatch(
      setRestaurant({ id, imgUrl, title, rating, genre, address, desc, dishes,lon,lat })
    );
  }, []);
  useLayoutEffect(() => {
    ...
    <>
      ...
      <ScrollView>
        ...
        <View className="bg-white">
          ...
          <TouchableOpacity className="p-4 flex-row items-center space-x-2 border-gray-200 border-y">
